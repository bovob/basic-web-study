...
@WebServlet("/ex04/session5")
public class Servlet_Session5 extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 세션을 무효화 시킨다.
        // invalidate 와 setCompelete(스프링의 임시데이터 날리기)는 다르다.
        session.invalidate();

        resp.setContentType("text/plain;charset=UTF-8");
        PrintWriter out = resp.getWriter();
        
        out.println("/ex04/session5 - 세션 무효화 확인");
